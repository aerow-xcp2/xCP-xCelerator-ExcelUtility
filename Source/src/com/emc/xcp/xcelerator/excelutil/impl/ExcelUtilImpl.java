package com.emc.xcp.xcelerator.excelutil.impl;
...
import com.emc.xcp.xcelerator.excelutil.IExcelUtil;
import com.emc.xcp.xcelerator.excelutil.params.ColumnWithValues;
 ...
 *
 */
public class ExcelUtilImpl extends DfSingleDocbaseModule implements IExcelUtil {

	public String test(String testou){
		return "testounet";
	}
	// < > interface methods
